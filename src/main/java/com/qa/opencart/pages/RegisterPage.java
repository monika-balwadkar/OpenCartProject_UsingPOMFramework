...
public class RegisterPage {
	...
	public boolean registerUser(String firstName, String lastName, 
		...
		eleUtil.waitForElementVisible(this.firstName, Constant.DEFAULT_SHORT_TIME_OUT).sendKeys(firstName);
		...
		String successMesg = eleUtil.waitForElementVisible(registerSuccessMesg, Constant.DEFAULT_MEDIUM_TIME_OUT).getText();
		System.out.println("user reg success messg : " + successMesg);
		
		if(successMesg.contains(Constant.USER_REG_SUCCESS_MESSG)) {
